...
2. Run `sudo nano /etc/audit/audit.conf` to edit the `auditd` config file using the following parameters. You can run this command from anywhere in the terminal.
